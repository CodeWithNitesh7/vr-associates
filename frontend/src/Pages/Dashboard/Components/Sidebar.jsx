...
import { LayoutDashboard, Users, Briefcase, Mail } from "lucide-react";
    ...
    return (
        <>
            ...
            >
                    ...
                    {sidebarItems.map((item) => (
                        ...
                        >
                            <item.icon
                                ...
                                ${activeItem !== item.id ? `${item.color} group-hover:text-indigo-400` : ""}`}
                            />
                ...
                <div className="mt-auto p-4 border-t border-gray-700 text-center text-gray-400 text-xs">
